...
function stopButtonOn(handleClick, toggleHover){
    ...
    const txtBoxButtons = document.querySelector('textarea[placeholder="Ready when you are!"]')?.closest("div.relative.flex")?.querySelectorAll("button"); //Select textbox
...
function stopButtonUpdate(){
    ...
    if (sendButton){
        ...
        const txtBoxArea = document.querySelector('textarea[placeholder="Ready when you are!"]').closest("div.relative.flex");
...
function addTextAreaId (){
  ...
  if (!document.querySelector("#text-area")){
    const textArea = document.querySelector('textarea[placeholder="Ready when you are!"]')?.closest("div.relative.flex")
    if (textArea) {
      ...
      const sendButtonDiv = document.querySelector('textarea[placeholder="Ready when you are!"]')?.closest('div.relative.flex')
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const targetSelector = 'textarea[placeholder="Ready when you are!"]';
  pastedContent = [];
